...
class PerformanceChartGenerator:
    ...
    def __init__(self, csv_file_path=None):
        self.csv_file_path = r"C:\Users\LENOVO\Desktop\LLM based IoT orchestration & verification\enhanced_test_report_20251013_122455.csv" #an example path and file，change to yours.
        self.df = None
        self.type_mapping = {
            'SD': 'Sensor Device',
            'AD': 'Actuator Device', 
    ...
    def create_combined_accuracy_chart(self, save_path=None):
        ...
        for bars in [bars1, bars2]:
            for bar in bars:
                ...
                # Move all number labels above the bars
